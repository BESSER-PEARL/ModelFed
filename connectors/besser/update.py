...
def update_property(obj: MvProperty, target: HttpUrl) -> None:
    ...
    common_attrs = {"name": "name", "isComposite": "is_composite",
                    "isNavigable": "is_navigable", "isId": "is_id"}
    ...
    if obj.multiplicity is not None:
        property_obj.multiplicity = parse_multiplicity(obj.multiplicity)
...
def update_package(obj: MvPackage, target: HttpUrl):
    ...
    if obj.elements is not None:
        package.elements = {get_object(element) for element in obj.elements}
