...
HazardLevel = Class(name="HazardLevel")
...
ProductPassport.attributes={ProductPassport_code, ProductPassport_name, ProductPassport_UID}

# HazardLevel class attributes and methods
HazardLevel_very_high: Property = Property(name="very_high", type=BooleanType)
HazardLevel_exed_limit: Property = Property(name="exed_limit", type=BooleanType)
HazardLevel.attributes={HazardLevel_very_high, HazardLevel_exed_limit}
...
RecycledMaterial.attributes={RecycledMaterial_preconsumer, RecycledMaterial_postconsumer, RecycledMaterial_renewable}
...
ChemicalProp.attributes={ChemicalProp_disclosure, ChemicalProp_threshold, ChemicalProp_composition}
...
LifecycleStage.attributes={LifecycleStage_start, LifecycleStage_name, LifecycleStage_end}
...
HazardToProductPassport: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="hazard", type=HazardLevel, multiplicity=Multiplicity(1, 1)),
...
domain_model = DomainModel(
    ...
    types={ProductPassport, HazardLevel, RecycledMaterial, ChemicalProp, LifecycleStage, Design, Manufacture, Use, Collect, Recycle, Reparation, Distribution},
