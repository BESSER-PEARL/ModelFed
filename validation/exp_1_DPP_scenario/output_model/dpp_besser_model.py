...
ProductPassport.attributes={ProductPassport_code, ProductPassport_UID, ProductPassport_name}
...
Reparation.attributes={Reparation_date_set, Reparation_description}
...
RecycledMaterial.attributes={RecycledMaterial_postconsumer, RecycledMaterial_preconsumer, RecycledMaterial_renewable}
...
domain_model = DomainModel(
    ...
    types={ProductPassport, LifecycleStage, Design, Manufacture, Use, Collect, Recycle, Reparation, Distribution, Hazard, RecycledMaterial, ChemicalProp},
    associations={LifecycleStageToProductPassport, UseToReparation, HazardToProductPassport, RecycledMaterialToProductPassport, ChemicalPropToProductPassport},
